...
def calculate_patient_age(birth_date: Union[str, date], reference_date: Optional[Union[str, date]] = None) -> Optional[int]:
    """
...
def add_patient_identifier(patient_data: Dict[str, Any], value: str, type_code: Optional[str] = None, 
                          use: str = "usual", system: Optional[str] = None) -> Dict[str, Any]:
    """
...
def add_condition_stage(condition_data: Dict[str, Any], stage_summary: str, 
                       assessment: Optional[List[str]] = None) -> Dict[str, Any]:
    """
...
def link_practitioner_to_organization(practitioner: Dict[str, Any], organization_ref: str) -> Dict[str, Any]:
...
def update_practitioner_affiliation(practitioner: Dict[str, Any], organization_ref: str, active: bool = True) -> Dict[str, Any]:
    affiliations = practitioner.get("affiliations") or []
    affiliations = [a for a in affiliations if a.get("organization") != organization_ref]
    affiliations.append({"organization": organization_ref, "active": active, "updated_at": datetime.now().isoformat()})
...
def link_organization_affiliation(organization: Dict[str, Any], parent_org_ref: str) -> Dict[str, Any]:
...
def check_allergy_contraindications(rx: Dict[str, Any], allergies: List[Dict[str, Any]]) -> Dict[str, Any]:
    """
...
def schedule_event_util(event_obj: Dict[str, Any], when: Optional[str] = None, start: Optional[str] = None, end: Optional[str] = None) -> Dict[str, Any]:
    if when:
...
def schedule_appointment_util(patient_ref: str, practitioner_ref: Optional[str], start: str, end: str, kind: Optional[str] = None) -> Dict[str, Any]:
    appt = {
        ...
        "end": end,
        "participant": [
            {"actor": patient_ref, "required": "required", "status": "accepted"}
        ],
        "created_at": datetime.now().isoformat(),
        "updated_at": datetime.now().isoformat(),
    }
...
# CarePlan utilities
def create_care_plan_util(patient_ref: str, title: Optional[str] = None, description: Optional[str] = None,
                          goals: Optional[List[str]] = None, activities: Optional[List[Dict[str, Any]]] = None) -> Dict[str, Any]:
    cp = {
...
def update_team_membership_util(care_team: Dict[str, Any], add: Optional[List[Dict[str, Any]]] = None,
                                remove_members: Optional[List[str]] = None) -> Dict[str, Any]:
    parts = care_team.get("participant") or []
    if remove_members:
...
def make_value_set(name: str, systems: Optional[List[Dict[str, str]]] = None, concepts: Optional[List[Dict[str, Any]]] = None) -> Dict[str, Any]:
    return {
...
def scan_codable_concepts(obj: Any, code_fields: Optional[List[str]] = None) -> List[Dict[str, Any]]:
    ...
    """
    targets = set(code_fields or ["code", "category", "type", "method", "interpretation"])  # common concept fields
