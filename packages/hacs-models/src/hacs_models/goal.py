...
class GoalTarget(DomainResource):
    ...
    measure: dict[str, Any] | None = Field(
        ...
        examples=[{"coding": [{"system": "http://loinc.org", "code": "33747-0", "display": "General appearance finding"}]}]
    )
    
    detail_quantity: dict[str, Any] | None = Field(
        default=None,
        description="Target value to be achieved as a quantity",
        examples=[{"value": 140, "unit": "mmHg", "system": "http://unitsofmeasure.org", "code": "mm[Hg]"}]
    )
    ...
    detail_codeable_concept: dict[str, Any] | None = Field(
        ...
        examples=[{"coding": [{"system": "http://snomed.info/sct", "code": "182840001", "display": "Drug treatment stopped"}]}]
    )
    ...
    detail_boolean: bool | None = Field(
        default=None,
        description="Target value to be achieved as a boolean"
    )
    
    detail_integer: int | None = Field(
        default=None,
        description="Target value to be achieved as an integer"
    )
    
    detail_ratio: dict[str, Any] | None = Field(
        default=None,
        description="Target value to be achieved as a ratio"
    )
    
    due_date: date | None = Field(
        default=None,
        description="Reach goal on or before this date"
    )
    
    due_duration: dict[str, Any] | None = Field(
        default=None,
        description="Reach goal within this duration",
        examples=[{"value": 30, "unit": "days", "system": "http://unitsofmeasure.org", "code": "d"}]
    )
...
class Goal(DomainResource):
    ...
    achievement_status: dict[str, Any] | None = Field(
        ...
        examples=[{"coding": [{"system": "goal-achievement", "code": "in-progress", "display": "In Progress"}]}]
    )
    ...
    category: list[dict[str, Any]] = Field(
        ...
        examples=[[{"coding": [{"system": "goal-category", "code": "dietary", "display": "Dietary"}]}]]
    )
    
    priority: dict[str, Any] | None = Field(
        default=None,
        description="Priority of the goal (high, medium, low)",
        examples=[{"coding": [{"system": "goal-priority", "code": "high-priority", "display": "High Priority"}]}]
    )
    ...
    start_codeable_concept: dict[str, Any] | None = Field(
        ...
        examples=[{"coding": [{"system": "goal-start-event", "code": "discharge", "display": "After discharge"}]}]
    )
    ...
    note: list[str] = Field(
        ...
        examples=[["Patient expressed strong motivation to achieve this goal", "Requires family support"]]
    )
    
    outcome_code: list[dict[str, Any]] = Field(
        default_factory=list,
        description="What result was achieved regarding the goal",
        examples=[[{"coding": [{"system": "goal-outcome", "code": "achieved", "display": "Goal achieved"}]}]]
    )
    ...
    def add_target(self, measure: dict[str, Any] | None = None, 
                   detail: Any = None, due_date: date | None = None) -> GoalTarget:
