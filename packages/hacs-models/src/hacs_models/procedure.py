...
class ProcedurePerformer(DomainResource):
    ...
    on_behalf_of: ResourceReference | None = Field(
        default=None,
        description="Organization the practitioner acted on behalf of"
    )
...
class ProcedureFocalDevice(DomainResource):
    ...
    manipulated: ResourceReference = Field(
...
class Procedure(DomainResource):
    ...
    performed_period_start: TimestampStr | None = Field(
        default=None,
        description="Start of when the procedure was performed"
    )
    
    performed_period_end: TimestampStr | None = Field(
        default=None,
        description="End of when the procedure was performed"
    )
    ...
    def add_performer(
        ...
        performer = ProcedurePerformer(
            actor=practitioner_ref,
            on_behalf_of=organization_ref
        )
    ...
    def add_body_site(self, site_text: str, site_code: str | None = None, system: str = "http://snomed.info/sct") -> CodeableConcept:
    ...
    def add_complication(self, complication_text: str, complication_code: str | None = None) -> CodeableConcept:
