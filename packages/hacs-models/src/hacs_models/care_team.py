...
class CareTeam(DomainResource):
    ...
    status: str = Field(default="active", description="proposed|active|suspended|inactive|entered-in-error")
    ...
    participant_refs: list[str] = Field(default_factory=list, description="Members (Practitioner/RelatedPerson/Organization)")
