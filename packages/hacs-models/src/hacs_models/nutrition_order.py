...
class NutritionOrder(DomainResource):
    ...
    status: str = Field(default="active", description="proposed|draft|active|on-hold|revoked|completed|entered-in-error|unknown")
    ...
    supplement_text: str | None = Field(default=None, description="Free text supplement instructions")
    enteral_formula_text: str | None = Field(default=None, description="Free text enteral formula instructions")
