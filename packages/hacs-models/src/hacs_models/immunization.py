...
class Immunization(DomainResource):
    ...
    vaccine_code: CodeableConcept | None = Field(default=None, description="Vaccine product administered")
    patient_ref: str | None = Field(default=None, description="Reference to Patient (e.g., Patient/123)")

    # Timing
    occurrence_datetime: str | None = Field(default=None, description="Date/time vaccine administered (ISO 8601)")
    recorded: str | None = Field(default=None, description="When the record was captured (ISO 8601)")
    ...
    manufacturer_ref: str | None = Field(default=None, description="Vaccine manufacturer Organization ref")
    ...
    note: list[str] = Field(default_factory=list, description="Additional notes about the immunization")
    reason_text: list[str] = Field(default_factory=list, description="Reasons immunization occurred (text)")
