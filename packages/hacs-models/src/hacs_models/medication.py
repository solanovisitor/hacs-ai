...
class MedicationIngredient(DomainResource):
    ...
    item_codeable_concept: CodeableConcept | None = Field(
        default=None,
        description="The actual ingredient (substance or other medication)"
    )
    
    # Reference to the ingredient
    item_reference: ResourceReference | None = Field(
        default=None,
        description="Reference to a Substance or Medication resource"
    )
    ...
    strength: dict[str, Any] | None = Field(
        ...
        examples=[{
            ...
            "denominator": {"value": 1, "unit": "tablet", "system": "http://unitsofmeasure.org"}
        }]
    )
...
class Medication(DomainResource):
    ...
    status: MedicationStatus | None = Field(
        default=None,
        description="Status of this medication (active, inactive, entered-in-error)"
    )
    ...
    def add_category(self, category_code: str, category_display: str, system: str = "http://terminology.hl7.org/CodeSystem/medication-category") -> CodeableConcept:
    ...
    def set_batch_info(self, lot_number: str | None = None, expiration_date: str | None = None) -> MedicationBatch:
        """Set batch information for the medication."""
        self.batch = MedicationBatch(
